        ...
        <div className="flex p-4 bg-gray-900 justify-between align-middle">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              id="table-search"
              className="p-2 pl-10 w-32 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-gray-500 focus:border-gray-500 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-gray-500 focus:border-gray-500"
              placeholder="search"
